              ...
              <div className="mt-6 flex items-center gap-3 border-t border-white/10 pt-6">
                ...
                {p.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    aria-label={t('testimonials.linkedinAria').replace('{name}', p.name)}
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-white/10 text-muted transition-colors hover:border-white/25 hover:text-ink"
                  >
                    <LinkedInIcon />
                  </a>
                )}
